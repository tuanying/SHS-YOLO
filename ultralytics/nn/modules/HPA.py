...
class HPA(nn.Module):
    ...
    def forward(self, x):
        ...
        )  # 2048,2,1,1-->2048,2,1--->2048,1,2
        x2.reshape(b * self.groups, c // self.groups, -1)  # b*g, c//g, hw  #2048,2,121
        self.softmax(self.agp(x2).reshape(b * self.groups, -1, 1).permute(0, 2, 1))  # 2048,2,1,1-->2048,2,1--->2048,1,2
