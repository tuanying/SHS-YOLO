...
def bbox_iou(box1, box2, xywh=True, 
             ...
             SDIoU=False,
             Focal=False, 
             alpha=1, delta=0.5, gamma=0.5, scale=False, eps=1e-7):
    ...
    if CIoU or DIoU or GIoU or EIoU or SIoU or WIoU or SDIoU:
        cw = b1_x2.maximum(b2_x2) - b1_x1.minimum(b2_x1)  # convex (smallest enclosing box) width
        ch = b1_y2.maximum(b2_y2) - b1_y1.minimum(b2_y1)  # convex height
        if CIoU or DIoU or EIoU or SIoU or WIoU or SDIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
